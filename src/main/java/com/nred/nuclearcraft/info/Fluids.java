...
public class Fluids {
    ...
    public static final TypeInfo SALT_SOLUTION_TYPE = new TypeInfo(false, "salt_solution_still", "salt_solution_flow", FluidType.Properties.create().density(5000).viscosity(8000).temperature(50).lightLevel(7).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL_LAVA).sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY_LAVA));
    public static final TypeInfo COOLANT_TYPE = new TypeInfo(false, "molten_still", "molten_flow", FluidType.Properties.create().density(5000).viscosity(15000).temperature(300).lightLevel(7).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL_LAVA).sound(SoundActions.BUCKET_EMPTY, SoundEvents.BUCKET_EMPTY_LAVA));
