...
public class Names {
    ...
    public static List<String> INGOTS = List.of("aluminum", "beryllium", "boron", "graphite", "lead", "lithium", "magnesium", "manganese", "manganese_dioxide", "manganese_oxide", "silver", "thorium", "tin", "uranium", "zirconium");
