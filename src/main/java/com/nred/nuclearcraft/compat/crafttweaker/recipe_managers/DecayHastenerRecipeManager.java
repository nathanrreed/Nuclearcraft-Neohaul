...
import static com.nred.nuclearcraft.registration.RecipeTypeRegistration.DECAY_HASTENER_RECIPE_TYPE;
...
public class DecayHastenerRecipeManager extends BasicNuclearRecipeManager<DecayHastenerRecipe> {
    ...
    @Override
    public RecipeType<DecayHastenerRecipe> getRecipeType() {
        return DECAY_HASTENER_RECIPE_TYPE.get();
    }
}