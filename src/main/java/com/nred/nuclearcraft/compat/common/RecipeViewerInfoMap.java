...
public class RecipeViewerInfoMap {
    ...
    private static Map<String, RecipeViewerInfo> createRecipeViewers() {
        ...
        map.put("centrifuge", new RecipeViewerInfo("centrifuge", new ScreenRectangle(36, 27, 120, 44), new ScreenPosition(42, 8), List.of(new ScreenPosition(3, 7)), List.of(new ScreenPosition(83, 7), new ScreenPosition(63, 7), new ScreenPosition(103, 7), new ScreenPosition(83, 27), new ScreenPosition(63, 27), new ScreenPosition(103, 27))));
