...
public class RecipeViewerInfoMap {
    ...
    private static Map<String, RecipeViewerInfo> createRecipeViewers() {
        ...
        map.put("chemical_reactor", new RecipeViewerInfo("chemical_reactor", new ScreenRectangle(28, 27, 136, 32), new ScreenPosition(42, 8), List.of(new ScreenPosition(3, 7), new ScreenPosition(23, 7)), List.of(new ScreenPosition(79, 3), new ScreenPosition(107, 3))));
