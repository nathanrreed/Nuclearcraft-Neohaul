...
public class RecipeViewerInfoMap {
    ...
    private static Map<String, RecipeViewerInfo> createRecipeViewers() {
        ...
        map.put("radiation_scrubber", new RecipeViewerInfo("radiation_scrubber", new ScreenRectangle(28, 27, 136, 32), new ScreenPosition(42, 7), List.of(new ScreenPosition(3, 7)), List.of(new ScreenPosition(23, 7)), List.of(new ScreenPosition(83, 7)), List.of(new ScreenPosition(107, 3))));
