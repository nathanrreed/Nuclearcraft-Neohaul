...
public class RotorBladeBuilder extends BlockBuilder {
    ...
    public RotorBladeBuilder setBladeData(Double efficiency, Double expansion_coefficient) {
        bladeType = new TurbineRotorBladeType(this.id.toString().replace(':', '_'), () -> efficiency, () -> expansion_coefficient);
        return this;
    }
    ...
    public Block createObject() {
        if (bladeType == null) throw new RuntimeException("Missing blade data! Must be set with setBladeData(efficiency, expansion)");
