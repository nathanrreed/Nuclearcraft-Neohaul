...
public class TriggerTypeRegistration {
    ...
    public static final Supplier<AssembleTrigger> DECAY_POOL_ASSEMBLED = TRIGGER_TYPES.register("decay_pool_assembled", AssembleTrigger::new);
    public static final Supplier<AssembleTrigger> PEBBLE_FISSION_ASSEMBLED = TRIGGER_TYPES.register("pebble_fission_reactor_assembled", AssembleTrigger::new);
