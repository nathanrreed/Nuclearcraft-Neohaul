...
public class DataMapTypeRegistration {
    public static final DataMapType<Block, MachineDiaphragmData> MACHINE_DIAPHRAGM_DATA = DataMapType.builder(ncLoc("machine_diaphragm_data"), Registries.BLOCK, MachineDiaphragmData.CODEC).synced(MachineDiaphragmData.CODEC, true).build();
