...
public class ItemRegistration {
    ...
    public static final DeferredItem<Item> BORON_SPAXELHOE = ITEMS.register("boron_spaxelhoe", () -> new SpaxelhoeItem(BORON_SPAXELHOE_TIER, new Properties().attributes(SpaxelhoeItem.createAttributes(BORON_SPAXELHOE_TIER, 3.0F, -2.4F)), ChatFormatting.GRAY));
    ...
    public static final DeferredItem<Item> BORON_NITRIDE_SPAXELHOE = ITEMS.register("boron_nitride_spaxelhoe", () -> new SpaxelhoeItem(BORON_NITRIDE_SPAXELHOE_TIER, new Properties().attributes(SpaxelhoeItem.createAttributes(BORON_NITRIDE_SPAXELHOE_TIER, 4.0F, -2.4F)), ChatFormatting.GREEN));
    ...
    public static final DeferredItem<Item> HARD_CARBON_SPAXELHOE = ITEMS.register("hard_carbon_spaxelhoe", () -> new SpaxelhoeItem(HARD_CARBON_SPAXELHOE_TIER, new Properties().attributes(SpaxelhoeItem.createAttributes(HARD_CARBON_SPAXELHOE_TIER, 3.5F, -2.4F)), ChatFormatting.BLUE));
