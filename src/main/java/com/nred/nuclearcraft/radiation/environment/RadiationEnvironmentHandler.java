...
import static com.nred.nuclearcraft.config.NCConfig.radiation_level_chunks_per_tick;
...
public class RadiationEnvironmentHandler {
    ...
    @SubscribeEvent
    public void updateRadiationEnvironment(LevelTickEvent.Pre event) {
        ...
        int count = Math.min((1 + radiation_level_chunks_per_tick) / 2, ENVIRONMENT.size());
