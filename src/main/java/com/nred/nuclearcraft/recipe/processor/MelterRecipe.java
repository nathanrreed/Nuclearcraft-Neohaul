...
public class MelterRecipe extends ProcessorRecipe {
    public MelterRecipe(List<SizedChanceItemIngredient> itemInputs, List<SizedChanceItemIngredient> itemResults, List<SizedChanceFluidIngredient> fluidInputs, List<SizedChanceFluidIngredient> fluidResults, double timeModifier, double powerModifier) {
    ...
    public RecipeType<?> getType() {
        return PROCESSOR_RECIPE_TYPES.get("melter").get();
    }
}