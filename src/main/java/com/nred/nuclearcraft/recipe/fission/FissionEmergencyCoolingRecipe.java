...
public class FissionEmergencyCoolingRecipe extends BasicRecipe {
    ...
    public FissionEmergencyCoolingRecipe(SizedChanceFluidIngredient fluidIngredient, SizedChanceFluidIngredient fluidProduct, double cooling_multiplier) {
    ...
    public static class Serializer implements RecipeSerializer<FissionEmergencyCoolingRecipe> {
        ...
        public static StreamCodec<RegistryFriendlyByteBuf, FissionEmergencyCoolingRecipe> STREAM_CODEC = StreamCodec.composite(
                SizedChanceFluidIngredient.STREAM_CODEC, FissionEmergencyCoolingRecipe::getFluidIngredient,
                SizedChanceFluidIngredient.STREAM_CODEC, FissionEmergencyCoolingRecipe::getFluidProduct,
