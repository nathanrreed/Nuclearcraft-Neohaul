...
public class CycleButton extends AbstractButton {
    ...
    public CycleButton(int x, int y, String type, String prefix, int index, ResourceLocation innerTexture) {
        ...
        setTooltip(Tooltip.create(Component.translatable(NuclearcraftNeohaul.MODID + "." + prefix, Component.translatable(NuclearcraftNeohaul.MODID + "." + options.getFirst().postfix()).withStyle(options.getFirst().color()))));
    }
    ...
    public void onClick(double mouseX, double mouseY, int button) {
        ...
        setTooltip(Tooltip.create(Component.translatable(NuclearcraftNeohaul.MODID + "." + prefix, Component.translatable(NuclearcraftNeohaul.MODID + "." + options.get(i).postfix()).withStyle(options.get(i).color()))));
    ...
    public void setTooltip() {
        setTooltip(Tooltip.create(Component.translatable(NuclearcraftNeohaul.MODID + "." + prefix, Component.translatable(NuclearcraftNeohaul.MODID + "." + options.get(getIndex()).postfix()).withStyle(options.get(getIndex()).color()))));
    }
}