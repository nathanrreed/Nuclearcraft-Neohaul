...
public abstract class ProcessorMenuInfoBuilder<TILE extends BlockEntity & IProcessor<TILE, PACKET, INFO, RECIPE>, PACKET extends ProcessorUpdatePacket, INFO extends ProcessorMenuInfo<TILE, PACKET, INFO, RECIPE>, RECIPE extends BasicRecipe, BUILDER extends ProcessorMenuInfoBuilder<TILE, PACKET, INFO, RECIPE, BUILDER>> extends MenuInfoBuilder<BUILDER> {
    ...
    protected ProcessorMenuInfoBuilder(String name, Class<TILE> tileClass, BiFunction<BlockPos, BlockState, TILE> tileSupplier, MenuFunction<TILE> menuFunction) {
        super(name);
    ...
    public BUILDER setDefaultProcessTime(int processTime) {
        defaultProcessTime = () -> processTime;
        return getThis();
    }

    public BUILDER setDefaultProcessPower(int processPower) {
        defaultProcessPower = () -> processPower;
        return getThis();
    }
