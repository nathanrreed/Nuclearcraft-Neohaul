...
public abstract class UpgradableProcessorMenuInfoBuilder<TILE extends BlockEntity & IProcessor<TILE, PACKET, INFO, RECIPE>, PACKET extends ProcessorUpdatePacket, INFO extends UpgradableProcessorMenuInfo<TILE, PACKET, INFO, RECIPE>, RECIPE extends BasicRecipe, BUILDER extends UpgradableProcessorMenuInfoBuilder<TILE, PACKET, INFO, RECIPE, BUILDER>> extends ProcessorMenuInfoBuilder<TILE, PACKET, INFO, RECIPE, BUILDER> {
    ...
    protected UpgradableProcessorMenuInfoBuilder(String name, Class<TILE> menuClass, BiFunction<BlockPos, BlockState, TILE> tileSupplier, MenuFunction<TILE> menuFunction) {
