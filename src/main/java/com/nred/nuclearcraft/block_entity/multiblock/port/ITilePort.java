package com.nred.nuclearcraft.block_entity.multiblock.port;
...
public interface ITilePort<MULTIBLOCK extends Multiblock<MULTIBLOCK> & ILogicMultiblock<MULTIBLOCK, LOGIC>, LOGIC extends MultiblockLogic<MULTIBLOCK, LOGIC>, PORT extends ITilePort<MULTIBLOCK, LOGIC, PORT, TARGET>, TARGET extends ITilePortTarget<MULTIBLOCK, LOGIC, PORT, TARGET>> extends ITileLogicMultiblockPart<MULTIBLOCK, LOGIC>, ITileSorptionPart<MULTIBLOCK> {
