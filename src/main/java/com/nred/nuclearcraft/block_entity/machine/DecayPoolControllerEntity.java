...
public class DecayPoolControllerEntity extends AbstractMachineEntity implements IMachineController<DecayPoolControllerEntity> {
    protected final BlockEntityMenuInfo<DecayPoolControllerEntity> info = BlockEntityInfoHandler.getTileContainerInfo("decay_pool_controller");

    protected boolean isRenderer = false;

    public DecayPoolControllerEntity(BlockPos pos, BlockState blockState) {
        super(MACHINE_ENTITY_TYPE.get("decay_pool_controller").get(), pos, blockState);
    }
    ...
    @Override
    public BlockEntityMenuInfo<DecayPoolControllerEntity> getContainerInfo() {
        return info;
    }
    ...
    public @Nullable AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new DecayPoolControllerMenu(containerId, playerInventory, this);
    }
