...
public class PebbleFissionControllerEntity extends AbstractFissionEntity implements IFissionController<PebbleFissionControllerEntity> {
    protected final BlockEntityMenuInfo<PebbleFissionControllerEntity> info = BlockEntityInfoHandler.getTileContainerInfo("pebble_fission_controller");

    public PebbleFissionControllerEntity(BlockPos pos, BlockState blockState) {
        super(FISSION_ENTITY_TYPE.get("pebble_fission_controller").get(), pos, blockState);
    }
    ...
    @Override
    public BlockEntityMenuInfo<PebbleFissionControllerEntity> getContainerInfo() {
        return info;
    }
    ...
    public @Nullable AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new PebbleFissionControllerMenu(containerId, playerInventory, this);
    }
