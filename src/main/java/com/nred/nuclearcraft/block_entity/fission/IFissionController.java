...
public interface IFissionController<CONTROLLER extends BlockEntity & IFissionController<CONTROLLER>> extends IFissionPart, ILogicMultiblockController<FissionReactor, FissionUpdatePacket, CONTROLLER, BlockEntityMenuInfo<CONTROLLER>> {
