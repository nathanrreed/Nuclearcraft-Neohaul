...
public class ModLanguageProvider extends LanguageProvider {
    ...
    private void turbine() {
        add("block." + MODID + ".turbine_controller.desc", "The heart of the multiblock - one is needed in the wall for it to form.");
        add("block." + MODID + ".turbine_rotor_shaft.desc", "Connects the rotor blades to the dynamo to convert the generated kinetic energy into electrical energy. Must be placed axially as a cuboid along the center of the multiblock interior.");
    ...
    private void buckets() {
        ...
        buckets(HOT_GAS_MAP, Map.of("sic_vapor", "Sublimated Silicon Carbide"));
        ...
        buckets(CUSTOM_FLUID_MAP, Map.of("radaway", "RadAway Fluid", "radaway_slow", "Slow-Acting RadAway Fluid", "le_water", "Low Enriched Water", "he_water", "Highly Enriched Water"));
