...
public class ModLanguageProvider extends LanguageProvider {
    ...
    private void turbine() {
        ...
        add(MODID + ".tooltip.turbine_rotor_blade", "Used to convert the energy of the oncoming fluid flow into rotational energy in the rotor shaft. The expansion coefficient is larger than unity, so the volume of the fluid flow will increase each time it passes through a set. Must be placed in complete sets of four coplanar groups extending from the multiblock shaft to the wall. Each blade block can process up to %s of oncoming fluid.");
        add(MODID + ".tooltip.turbine_rotor_stator_expansion", "Expansion Coefficient: %s");
        add(MODID + ".tooltip.turbine_rotor_stator", "Used to increase the density of the oncoming fluid flow, which can increase the efficiency of the multiblock by counteracting overexpansion generated by sets of rotor blades. Must be placed in complete sets of four coplanar groups extending from the multiblock shaft to the wall.");
