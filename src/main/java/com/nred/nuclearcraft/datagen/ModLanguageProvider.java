...
public class ModLanguageProvider extends LanguageProvider {
    ...
    private void turbine() {
        add("tooltip.turbine_controller", "The heart of the turbine - one is needed in the wall for it to form.");
        add("tooltip.turbine_rotor_shaft", "Connects the rotor blades to the dynamo to convert the generated kinetic energy into electrical energy. Must be placed axially as a cuboid along the center of the turbine interior.");
        add("tooltip.turbine_rotor_blade_efficiency", "Efficiency Multiplier: %s");
        add("tooltip.turbine_rotor_blade_expansion", "Expansion Coefficient: %s");
        add("tooltip.turbine_rotor_blade", "Used to convert the energy of the oncoming fluid flow into rotational energy in the rotor shaft. The expansion coefficient is larger than unity, so the volume of the fluid flow will increase each time it passes through a set. Must be placed in complete sets of four coplanar groups extending from the turbine shaft to the wall. Each blade block can process up to %s of oncoming fluid.");
        add("tooltip.turbine_rotor_stator_expansion", "Expansion Coefficient: %s");
        add("tooltip.turbine_rotor_stator", "Used to increase the density of the oncoming fluid flow, which can increase the efficiency of the turbine by counteracting overexpansion generated by sets of rotor blades. Must be placed in complete sets of four coplanar groups extending from the turbine shaft to the wall.");
        add("tooltip.turbine_rotor_bearing", "Connects the rotor shaft to the turbine wall and dynamo. Must cover the full area of each end of the shaft. Dynamo coils must be connected to the bearings either directly or via other dynamo coils and dynamo coil connectors. Connecting at least as many coils as bearing blocks at each end will avoid efficiency penalties.");
        add("tooltip.turbine_dynamo_coil.conductivity", "Conductivity Multiplier: %s");
        add("tooltip.turbine_computer_port", "Used to access the turbine via OpenComputers.");

        add("recipe_viewer.turbine_energy_density", "Base Energy Density: %s");
        add("recipe_viewer.turbine_expansion", "Fluid Expansion: %s");
        add("recipe_viewer.turbine_spin_up_multiplier", "Spin-up Multiplier: %s");
    }
