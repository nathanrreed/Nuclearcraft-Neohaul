...
public class ModLanguageProvider extends LanguageProvider {
    ...
    private void turbine() {
        ...
        add(TURBINE_MAP.get("turbine_computer_port").get().getDescriptionId() + ".desc", "Used to access the turbine via CC: Tweaked.");
    ...
    private void fission_reactor() {
        ...
        add(FISSION_REACTOR_MAP.get("fission_computer_port").get().getDescriptionId() + ".desc", "Used to access the reactor via CC: Tweaked.");
    ...
    private void heat_exchanger() {
        ...
        add(HX_MAP.get("heat_exchanger_computer_port").get().getDescriptionId() + ".desc", "Used to access the exchanger via CC: Tweaked.");
    }
    ...
    private void machine() {
        ...
        add(MACHINE_MAP.get("large_machine_computer_port").get().getDescriptionId() + ".desc", "Used to access the machine via CC: Tweaked.");
