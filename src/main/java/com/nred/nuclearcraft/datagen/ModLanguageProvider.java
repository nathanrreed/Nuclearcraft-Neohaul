...
//add(MODID + ".configuration.heat_exchanger_heat_transfer_coefficient.tooltip", "Multiplier for the heat transfer rate from this type of tube. Order: copper, hard carbon, thermoconducting alloy.");
//add(MODID + ".configuration.heat_exchanger_heat_retention_mult", "Tube Heat Retention Multiplier");
//add(MODID + ".configuration.heat_exchanger_heat_retention_mult.tooltip", "Multiplier for the contribution to the heating rate from this type of tube. Order: copper, hard carbon, thermoconducting alloy.");
...
//add(MODID + ".configuration.heat_exchanger_alternate_hps_recipe", "Alternate HPS Recipe");
//add(MODID + ".configuration.heat_exchanger_alternate_hps_recipe.tooltip", "Will high pressure steam be cooled into standard steam rather than low pressure steam?");
//add(MODID + ".configuration.heat_exchanger_alternate_exhaust_recipe", "Alternate Exhaust Steam Recipe");
//add(MODID + ".configuration.heat_exchanger_alternate_exhaust_recipe.tooltip", "Will exhaust steam be heated into standard steam rather than low pressure steam?");
