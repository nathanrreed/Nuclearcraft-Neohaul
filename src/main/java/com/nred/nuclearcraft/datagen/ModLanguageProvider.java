...
public class ModLanguageProvider extends LanguageProvider {
    ...
    private void turbine() {
        add(NuclearcraftNeohaul.MODID + ".tooltip.turbine_controller", "The heart of the multiblock - one is needed in the wall for it to form.");
        add(NuclearcraftNeohaul.MODID + ".tooltip.turbine_rotor_shaft", "Connects the rotor blades to the dynamo to convert the generated kinetic energy into electrical energy. Must be placed axially as a cuboid along the center of the multiblock interior.");
        ...
        add(NuclearcraftNeohaul.MODID + ".tooltip.turbine_rotor_stator", "Used to increase the density of the oncoming fluid flow, which can increase the efficiency of the multiblock by counteracting overexpansion generated by sets of rotor blades. Must be placed in complete sets of four coplanar groups extending from the multiblock shaft to the wall.");
        add(NuclearcraftNeohaul.MODID + ".tooltip.turbine_rotor_bearing", "Connects the rotor shaft to the multiblock wall and dynamo. Must cover the full area of each end of the shaft. Dynamo coils must be connected to the bearings either directly or via other dynamo coils and dynamo coil connectors. Connecting at least as many coils as bearing blocks at each end will avoid efficiency penalties.");
        add(NuclearcraftNeohaul.MODID + ".tooltip.turbine_dynamo_coil.conductivity", "Conductivity Multiplier: %s");
        add(NuclearcraftNeohaul.MODID + ".tooltip.turbine_computer_port", "Used to access the multiblock via CC: Tweaked.");
        ...
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.need_bearings", "There must be two sets of rotor bearings in opposing walls of the multiblock for it to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.bearings_side_square", "The walls housing the rotor bearings must be square for the multiblock to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.valve_wrong_wall", "Inlets and outlets must be installed opposite each other on the walls housing the rotor bearings for the multiblock to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.bearings_center_and_square", "The sets of rotor bearings must be square and centered in the middle of each opposing wall for the multiblock to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.shaft_center", "The rotor shaft must be fully connected to each set of rotor bearings for the multiblock to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.space_between_blades", "The space between the sets of rotor blades and stators must be empty for the multiblock to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.different_type_blades", "The rotor blades or stators about each section of the rotor shaft must be of the same type for the multiblock to form");
        add(NuclearcraftNeohaul.MODID + ".multiblock_validation.multiblock.missing_blades", "Each section of the rotor shaft must have rotor blades or stators of the same type extend fully to the wall for the multiblock to form");
    }

    private void fission_reactor() {
        add(NuclearcraftNeohaul.MODID + ".tooltip.solid_fission_sink.cooling_rate", "Cooling Rate: %s H/t");
        add(NuclearcraftNeohaul.MODID + ".tooltip.salt_fission_heater.cooling_rate", "Cooling Rate: %s H/t");
...
//        fuelTypeItems(THORIUM_MAP, "Thorium-", "");
    ...
    private void tooltips() {
        ...
        add(NuclearcraftNeohaul.MODID + ".tooltip.vent_toggle", "Toggled vent to %s mode!");
        add(NuclearcraftNeohaul.MODID + ".tooltip.port_toggle", "Toggled port to %s mode!");
    }
