...
public class ModLanguageProvider extends LanguageProvider {
    ...
    private void turbine() {
        add("block." + MODID + ".turbine_controller.desc", "The heart of the turbine - one is needed in the wall for it to form.");
        add("block." + MODID + ".turbine_rotor_shaft.desc", "Connects the rotor blades to the dynamo to convert the generated kinetic energy into electrical energy. Must be placed axially as a cuboid along the center of the turbine interior.");
        ...
        add("block." + MODID + ".turbine_rotor_stator.desc", "Used to increase the density of the oncoming fluid flow, which can increase the efficiency of the turbine by counteracting overexpansion generated by sets of rotor blades. Must be placed in complete sets of four coplanar groups extending from the turbine shaft to the wall.");
    ...
    private void fission_reactor() {
        ...
        addTooltip(FISSION_REACTOR_MAP.get("fission_computer_port"), "Used to access the reactor via CC: Tweaked.");
    ...
    private void heat_exchanger() {
        ...
        addTooltip(HX_MAP.get("heat_exchanger_computer_port"), "Used to access the exchanger via CC: Tweaked.");
    }
    ...
    private void items() {
        ...
        replaceItems(ALLOYS, ALLOY_MAP, "", " Alloy Ingot", Map.of(
                "hsla_steel", "HSLA Steel Ingot",
                "steel", "Steel Ingot",
                "zircaloy", "Zircaloy Ingot",
                "hastelloy", "Hastelloy Ingot",
        ...
        replaceItems(PARTS, PART_MAP, "", "", Map.of(
                ...
                "polymethylsilylene_methylene", "Polymethylsilylene-Methylene",
                "polytetrafluoroethene", "Polytetrafluoroethylene"
        ));
        simpleItems(PART_BLOCKS, PART_BLOCK_MAP, "");
        replaceItems(COMPOUNDS, COMPOUND_MAP, "", "", Map.of(
                "c_mn_blend", "Carbon-Manganese Blend",
                "alugentum", "Alugentum Dust"
        ));
        ...
        simpleItems(s -> s.replace("tough", "tough_alloy"), TOUGH_HELMET, TOUGH_CHESTPLATE, TOUGH_LEGGINGS, TOUGH_BOOTS);
        ...
        simpleItems(s -> s.replace("tough", "tough_alloy"), TOUGH_SWORD, TOUGH_PICKAXE, TOUGH_SHOVEL, TOUGH_AXE, TOUGH_HOE, TOUGH_SPAXELHOE);
        ...
        addTooltip(TOUGH_SPAXELHOE, "A universal tool made up of all of the standard Tough Alloy tools. Sneak to use shovel flattening.");
        ...
        add(FUEL_MIXED_MAP.get("mix_239_tr").get(), "MTRISO-239 Fuel Pebble");
        ...
        add(FUEL_MIXED_MAP.get("mix_241_tr").get(), "MTRISO-241 Fuel Pebble");
    ...
    private void blocks() {
        ...
        add(COLLECTOR_MAP.get("water_source").asItem(), "Infinite Water Source");
        add(COLLECTOR_MAP.get("water_source_compact").asItem(), "Compact Infinite Water Source");
        add(COLLECTOR_MAP.get("water_source_dense").asItem(), "Dense Infinite Water Source");
        add(COLLECTOR_MAP.get("nitrogen_collector").asItem(), "Nitrogen Collector");
        add(COLLECTOR_MAP.get("nitrogen_collector_compact").asItem(), "Compact Nitrogen Collector");
        add(COLLECTOR_MAP.get("nitrogen_collector_dense").asItem(), "Dense Nitrogen Collector");
        ...
        simpleBlocks(TURBINE_MAP, Map.of(
                "sic_turbine_rotor_blade", "SiC-SiC CMC Turbine Rotor Blade",
                "turbine_inlet", "Turbine Fluid Inlet",
                "turbine_outlet", "Turbine Fluid Outlet",
                "turbine_coil_connector", "Turbine Dynamo Coil Connector"
        ));
        Map<String, String> fission = new HashMap<>(Map.of(
                ...
                "beryllium_carbon_reflector", "Beryllium-Carbon Neutron Reflector",
                "lead_steel_reflector", "Lead-Steel Neutron Reflector",
                "fission_source_manager", "Fission Neutron Source Manager",
                "fission_shield_manager", "Fission Neutron Shield Manager"
        ));
        fission.putAll(Map.of(
                "fission_casing", "Fission Reactor Casing",
                "fission_glass", "Fission Reactor Glass",
                "fission_conductor", "Fission Reactor Conductor",
                "fission_vent", "Fission Reactor Vent",
                "fission_power_port", "Fission Reactor Power Port",
                "fission_monitor", "Fission Reactor Monitor"
        ));
        fission.putAll(Map.of(
                "ethene_fission_gas_cooler", "Ethylene Fission Gas Cooler",
                "ethene_fission_gas_cooler_port", "Ethylene Fission Gas Cooler Port",
                "ethyne_fission_gas_cooler", "Acetylene Fission Gas Cooler",
                "ethyne_fission_gas_cooler_port", "Acetylene Fission Gas Cooler Port"
        ));
        simpleBlocks(FISSION_REACTOR_MAP, fission);

        simpleBlocks(BATTERY_MAP, Map.of("du_voltaic_pile", "DU Voltaic Pile", "du_lithium_ion_battery", "DU Lithium Ion Battery"));
        simpleBlocks(HX_MAP, Map.of(
                "heat_exchanger_inlet", "Heat Exchanger Fluid Inlet",
                "heat_exchanger_outlet", "Heat Exchanger Fluid Outlet"
        ));
        simpleBlocks(MACHINE_MAP, Map.of(
                "large_machine_frame", "Large Machine Casing",
                "polytetrafluoroethene_sieve_assembly", "Polytetrafluoroethylene Sieve Assembly"
        ));
        quantum();
    }

    private void quantum() {
        add(QUANTUM_MAP.get("x").asItem(), "Quantum Computer Pauli-X Gate");
        addTooltip(QUANTUM_MAP.get("x"), "Rotates the target qubits by 180 degrees about the X-axis of the Bloch sphere.");
        add(QUANTUM_MAP.get("y").asItem(), "Quantum Computer Pauli-Y Gate");
        addTooltip(QUANTUM_MAP.get("y"), "Rotates the target qubits by 180 degrees about the Y-axis of the Bloch sphere.");
        add(QUANTUM_MAP.get("z").asItem(), "Quantum Computer Pauli-Z Gate");
        addTooltip(QUANTUM_MAP.get("z"), "Rotates the target qubits by 180 degrees about the Z-axis of the Bloch sphere.");
        add(QUANTUM_MAP.get("h").asItem(), "Quantum Computer Hadamard Gate");
        addTooltip(QUANTUM_MAP.get("h"), "Applies a Hadamard transform to the target qubits.");
        add(QUANTUM_MAP.get("s").asItem(), "Quantum Computer S Gate");
        addTooltip(QUANTUM_MAP.get("s"), "Shifts the phase of the true-value components of the target qubits by 90 degrees.");
        add(QUANTUM_MAP.get("sdg").asItem(), "Quantum Computer Inverse S Gate");
        addTooltip(QUANTUM_MAP.get("sdg"), "Shifts the phase of the true-value components of the target qubits by 270 degrees.");
        add(QUANTUM_MAP.get("t").asItem(), "Quantum Computer T Gate");
        addTooltip(QUANTUM_MAP.get("t"), "Shifts the phase of the true-value components of the target qubits by 45 degrees.");
        add(QUANTUM_MAP.get("tdg").asItem(), "Quantum Computer Inverse T Gate");
        addTooltip(QUANTUM_MAP.get("tdg"), "Shifts the phase of the true-value components of the target qubits by 315 degrees.");
        add(QUANTUM_MAP.get("p").asItem(), "Quantum Computer Phase Gate");
        addTooltip(QUANTUM_MAP.get("p"), "Shifts the phase of the true-value components of the target qubits by a chosen angle.");
        add(QUANTUM_MAP.get("rx").asItem(), "Quantum Computer X-Rotation Gate");
        addTooltip(QUANTUM_MAP.get("rx"), "Rotates the target qubits about the spatial X-axis.");
        add(QUANTUM_MAP.get("ry").asItem(), "Quantum Computer Y-Rotation Gate");
        addTooltip(QUANTUM_MAP.get("ry"), "Rotates the target qubits about the spatial Y-axis.");
        add(QUANTUM_MAP.get("rz").asItem(), "Quantum Computer Z-Rotation Gate");
        addTooltip(QUANTUM_MAP.get("rz"), "Rotates the target qubits about the spatial Z-axis.");
        add(QUANTUM_MAP.get("cx").asItem(), "Quantum Computer Controlled Pauli-X Gate");
        addTooltip(QUANTUM_MAP.get("cx"), "Performs a controlled rotation on the target qubits by 180 degrees about the X-axis of the Bloch sphere.");
        add(QUANTUM_MAP.get("cy").asItem(), "Quantum Computer Controlled Pauli-Y Gate");
        addTooltip(QUANTUM_MAP.get("cy"), "Performs a controlled rotation on the target qubits by 180 degrees about the Y-axis of the Bloch sphere.");
        add(QUANTUM_MAP.get("cz").asItem(), "Quantum Computer Controlled Pauli-Z Gate");
        addTooltip(QUANTUM_MAP.get("cz"), "Performs a controlled rotation on the target qubits by 180 degrees about the Z-axis of the Bloch sphere.");
        add(QUANTUM_MAP.get("ch").asItem(), "Quantum Computer Controlled Hadamard Gate");
        addTooltip(QUANTUM_MAP.get("ch"), "Applies a controlled Hadamard transform to the target qubits.");
        add(QUANTUM_MAP.get("cs").asItem(), "Quantum Computer Controlled S Gate");
        addTooltip(QUANTUM_MAP.get("cs"), "Performs a controlled phase shift on the true-value components of the target qubits by 90 degrees.");
        add(QUANTUM_MAP.get("csdg").asItem(), "Quantum Computer Controlled Inverse S Gate");
        addTooltip(QUANTUM_MAP.get("csdg"), "Performs a controlled phase shift on the true-value components of the target qubits by 270 degrees.");
        add(QUANTUM_MAP.get("ct").asItem(), "Quantum Computer Controlled T Gate");
        addTooltip(QUANTUM_MAP.get("ct"), "Performs a controlled phase shift on the true-value components of the target qubits by 45 degrees.");
        add(QUANTUM_MAP.get("ctdg").asItem(), "Quantum Computer Controlled Inverse T Gate");
        addTooltip(QUANTUM_MAP.get("ctdg"), "Performs a controlled phase shift on the true-value components of the target qubits by 315 degrees.");
        add(QUANTUM_MAP.get("cp").asItem(), "Quantum Computer Controlled Phase Gate");
        addTooltip(QUANTUM_MAP.get("cp"), "Performs a controlled phase shift on the true-value components of the target qubits by a chosen angle.");
        add(QUANTUM_MAP.get("crx").asItem(), "Quantum Computer Controlled X-Rotation Gate");
        addTooltip(QUANTUM_MAP.get("crx"), "Performs a controlled rotation on the target qubits about the spatial X-axis.");
        add(QUANTUM_MAP.get("cry").asItem(), "Quantum Computer Controlled Y-Rotation Gate");
        addTooltip(QUANTUM_MAP.get("cry"), "Performs a controlled rotation on the target qubits about the spatial Y-axis.");
        add(QUANTUM_MAP.get("crz").asItem(), "Quantum Computer Controlled Z-Rotation Gate");
        addTooltip(QUANTUM_MAP.get("crz"), "Performs a controlled rotation on the target qubits about the spatial Z-axis.");
        add(QUANTUM_MAP.get("swap").asItem(), "Quantum Computer Swap Gate");
        addTooltip(QUANTUM_MAP.get("swap"), "Swaps two lists of qubits.");
        add(QUANTUM_MAP.get("cswap").asItem(), "Quantum Computer Controlled Swap Gate");
        addTooltip(QUANTUM_MAP.get("cswap"), "Performs a controlled swap on two lists of qubits.");

        add(QUANTUM_MAP.get("quantum_computer_code_generator_qasm").asItem(), "Quantum Computer QASM Code Generator");
        addTooltip(QUANTUM_MAP.get("quantum_computer_code_generator_qasm"), "Used to generate QASM code for use with IBM Q.");
        add(QUANTUM_MAP.get("quantum_computer_code_generator_qiskit").asItem(), "Quantum Computer Qiskit Code Generator");
        addTooltip(QUANTUM_MAP.get("quantum_computer_code_generator_qiskit"), "Used to generate Qiskit code for use with IBM Q.");
        add(QUANTUM_MAP.get("quantum_computer_port").asItem(), capitalize("quantum_computer_port"));
        addTooltip(QUANTUM_MAP.get("quantum_computer_port"), "Used to access the Quantum Computer via CC: Tweaked.");
        add(QUANTUM_MAP.get("quantum_computer_controller").asItem(), capitalize("quantum_computer_controller"));
        add(QUANTUM_MAP.get("quantum_computer_qubit").asItem(), capitalize("quantum_computer_qubit"));
        add(QUANTUM_MAP.get("quantum_computer_connector").asItem(), capitalize("quantum_computer_connector"));
    }

    private void buckets() {
        buckets(GAS_MAP, Map.of(
                "tetrafluoroethene", "Tetrafluoroethylene",
                "ethene", "Ethylene",
                "ethyne", "Acetylene"
        ));
        Map<String, String> molten = new HashMap<>(Map.of(
                "lif", "Molten Lithium Fluoride",
                "bef2", "Molten Beryllium Fluoride",
                "flibe", "Molten FLiBe Salt Mixture",
                "naoh", "Molten Sodium Hydroxide",
                "koh", "Molten Potassium Hydroxide",
                "tough", "Molten Tough Alloy",
                "coal", "Liquefacted Coal",
                "dfdps", "Molten Difluorodiphenyl Sulfone",
        ...
        gasBuckets(HOT_GAS_MAP, Map.of(
                "sic_vapor", "Sublimated Silicon Carbide",
                "arsenic", "Sublimated Arsenic",
        ...
        buckets(CUSTOM_FLUID_MAP, Map.of(
                "radaway", "RadAway Fluid",
                "radaway_slow", "Slow-Acting RadAway Fluid",
                "le_water", "Low Enriched Water",
                "he_water", "Highly Enriched Water",
                "cryotheum", "Molten Cryotheum",
                "ender", "Molten Ender",
                "emergency_coolant_heated", "Heated Emergency Coolant",
                "ice", "Crushed Ice"
        ));
        Map<String, String> fission_fuel = new HashMap<>(Map.of(
                "mix_239_fluoride", "Molten MF4-239",
                "mix_241_fluoride", "Molten MF4-241",
                "depleted_mix_239_fluoride", "Molten Depleted MF4-239",
                "depleted_mix_241_fluoride", "Molten Depleted MF4-241",
                "mix_239_fluoride_flibe", "Molten FLiBe Salt Solution of MF4-239 Fuel",
                "mix_241_fluoride_flibe", "Molten FLiBe Salt Solution of MF4-241 Fuel",
                "depleted_mix_239_fluoride_flibe", "Molten FLiBe Salt Solution of Depleted MF4-239 Fuel",
                "depleted_mix_241_fluoride_flibe", "Molten FLiBe Salt Solution of Depleted MF4-241 Fuel"));
        fission_fuel.putAll(Map.of(
                "tbu_fluoride", "Molten TBU Fluoride",
                "depleted_tbu_fluoride", "Molten Depleted TBU Fluoride",
                "tbu_fluoride_flibe", "Molten FLiBe Salt Solution of TBU Fluoride Fuel",
                "depleted_tbu_fluoride_flibe", "Molten FLiBe Salt Solution of Depleted TBU Fluoride Fuel"
        ));
        ...
        for (String fluid : type.keySet()) {
            ...
            if (!replacers.containsKey(fluid)) {
                ...
                if (Pattern.compile("hec([mf])").matcher(fluid).find()) {
                    ...
                    name = capitalize(fluid, true);
                }
                name = prefix + name + suffix;
            } else {
                name = replacers.get(fluid);
            }
        ...
        for (String fluid : type.keySet()) {
            String name = switch (fluid) {
                ...
                case String temp -> {
                    ...
                    temp = temp.replaceFirst("^liquid_", "");
    ...
    private void gasBuckets(Map<String, NCFluid> type, Map<String, String> replacers) {
        for (String fluid : type.keySet()) {
            ...
            if (fluid.endsWith("_hot")) {
                name = "Hot_" + fluid.replace("_hot", "");
            } else if (fluid.endsWith("_exhaust")) {
                name = "Exhaust_" + fluid.replace("_exhaust", "");
            }

            name = replacers.getOrDefault(fluid, capitalize(name));
            add(type.get(fluid).bucket.asItem(), name + " Bucket");
            add(type.get(fluid).type.get().getDescriptionId(), name);
            add(type.get(fluid).block.get(), name);
        }
    ...
    private void messages() {
        ...
        add(MODID + ".multitool.quantum_computer.remove_qubit", "Removed qubit ID %s from multitool");
        add(MODID + ".multitool.quantum_computer.add_qubit", "Saved qubit ID %s to multitool");

        add(MODID + ".multitool.quantum_computer.single_gate_info", "%s currently targeting qubits %s");
        add(MODID + ".multitool.quantum_computer.start_target_set", "%s now waiting for set of target qubits...");
        add(MODID + ".multitool.quantum_computer.finish_target_set", "%s now targeting qubits %s");

        add(MODID + ".multitool.quantum_computer.single_angle_gate_info", "%s currently targeting qubits %s with working angle %s degrees");
        add(MODID + ".multitool.quantum_computer.start_angle", "%s now waiting for working angle...");
        add(MODID + ".multitool.quantum_computer.tool_set_angle", "Saved angle of %s degrees to multitool");
        add(MODID + ".multitool.quantum_computer.finish_angle", "%s now working at %s degrees");

        add(MODID + ".multitool.quantum_computer.control_gate_info", "%s currently targeting qubits %s with control qubits %s");
        add(MODID + ".multitool.quantum_computer.start_control_set", "%s now waiting for set of control qubits...");
        add(MODID + ".multitool.quantum_computer.finish_control_set", "%s now controlled by qubits %s");

        add(MODID + ".multitool.quantum_computer.control_angle_gate_info", "%s currently targeting qubits %s with working angle %s degrees and control qubits %s");

        add(MODID + ".multitool.quantum_computer.swap_gate_info", "%s currently swapping qubits %s with qubits %s");
        add(MODID + ".multitool.quantum_computer.start_first_swap_list", "%s now waiting for first list of qubits...");
        add(MODID + ".multitool.quantum_computer.finish_first_swap_list", "%s now set to swap first list of qubits %s");
        add(MODID + ".multitool.quantum_computer.start_second_swap_list", "%s now waiting for second list of qubits...");
        add(MODID + ".multitool.quantum_computer.finish_second_swap_list", "%s now set to swap second list of qubits %s");

        add(MODID + ".multitool.quantum_computer.control_swap_gate_info", "%s currently swapping qubits %s with qubits %s, controlled by qubits %s");

        add(MODID + ".multitool.quantum_computer.controller.code_qasm_start", "Quantum Computer entering QASM mode! Gate operations will be recorded but not carried out in the game");
        add(MODID + ".multitool.quantum_computer.controller.code_qiskit_start", "Quantum Computer entering Qiskit mode! Gate operations will be recorded but not carried out in the game");
        add(MODID + ".multitool.quantum_computer.controller.code_too_many_qubits", "Quantum Computer can not enter code generation mode, too many qubits installed");
        add(MODID + ".multitool.quantum_computer.controller.code_exit_too_many_qubits", "Quantum Computer exiting code generation mode, too many qubits installed");
        add(MODID + ".multitool.quantum_computer.controller.code_exit_empty", "Quantum Computer exiting code generation mode");

        add(MODID + ".multitool.quantum_computer.controller.qasm_print", "Quantum Computer exiting QASM mode, saved generated code to %s");
        add(MODID + ".multitool.quantum_computer.controller.qasm_error", "Quantum Computer exiting QASM mode, an error occurred attempting save generated code to %s");
        add(MODID + ".multitool.quantum_computer.controller.qasm_exit_empty", "Quantum Computer exiting QASM mode.");
        add(MODID + ".multitool.quantum_computer.controller.qiskit_print", "Quantum Computer exiting Qiskit mode, saved generated code to %s");
        add(MODID + ".multitool.quantum_computer.controller.qiskit_error", "Quantum Computer exiting Qiskit mode, an error occurred attempting save generated code to %s");
        add(MODID + ".multitool.quantum_computer.controller.qiskit_exit_empty", "Quantum Computer exiting Qiskit mode.");
    ...
    private void tooltips() {
        ...
        add(MODID + ".tooltip.marshmallow", "Many civilizations would not have fallen with these on their side.");
        add(MODID + ".tooltip.dominos", "Paul's favourite.");
    ...
    private void multiblock_validation() {
        ...
        // Turbine
        add(MODID + ".multiblock_validation.turbine.need_bearings", "There must be two sets of rotor bearings in opposing walls of the turbine for it to form");
        add(MODID + ".multiblock_validation.turbine.bearings_side_square", "The walls housing the rotor bearings must be square for the turbine to form");
        add(MODID + ".multiblock_validation.turbine.valve_wrong_wall", "Inlets and outlets must be installed opposite each other on the walls housing the rotor bearings for the turbine to form");
        add(MODID + ".multiblock_validation.turbine.bearings_center_and_square", "The sets of rotor bearings must be square and centered in the middle of each opposing wall for the turbine to form");
        add(MODID + ".multiblock_validation.turbine.shaft_center", "The rotor shaft must be fully connected to each set of rotor bearings for the turbine to form");
    ...
    private void config() {
        ...
        add(MODID + ".configuration.energy_upgrade_fp_order", "Processor Power, Generator Time");
        add(MODID + ".configuration.upgrade_order", "Speed, Energy");
        add(MODID + ".configuration.processor_passive_rate_order", "Cobblestone Generator, Infinite Water Source, Nitrogen Collector");
        ...
        add(MODID + ".configuration.speed_upgrade_multipliers_fp.tooltip", "Base multipliers for speed upgrades.");
        add(MODID + ".configuration.energy_upgrade_power_laws_fp", "Energy Upgrade Power Laws");
        add(MODID + ".configuration.energy_upgrade_power_laws_fp.tooltip", "Power laws for energy upgrades.");
        add(MODID + ".configuration.energy_upgrade_multipliers_fp", "Energy Upgrade Multipliers");
        add(MODID + ".configuration.energy_upgrade_multipliers_fp.tooltip", "Base multipliers for energy upgrades.");
        add(MODID + ".configuration.upgrade_stack_sizes", "Upgrade Max Stack Sizes");
        add(MODID + ".configuration.upgrade_stack_sizes.tooltip", "Max stack sizes for upgrades.");
        ...
        add(MODID + ".configuration.processor_passive_rate.tooltip", "Rates at which passive machines produce materials.");
        ...
        add(MODID + ".configuration.fission_sink_rule.tooltip", "Placement rule to be parsed for heat sinks of this type.");
        add(MODID + ".configuration.fission_heater_cooling_rate", "Coolant Heater Cooling Rates");
        ...
        add(MODID + ".configuration.fission_shield_efficiency.tooltip", "Efficiency multipliers for neutron shields of this type.");
        ...
        //  add(MODID + ".configuration.fusion_fuel_time_multiplier", "Fuel Use Multiplier"); TODO
        ...
        add(MODID + ".configuration.heat_exchanger_heat_transfer_coefficient", "Tube Heat Transfer Coefficient");
        ...
        add(MODID + ".configuration.turbine_blade_efficiency.tooltip", "Multiplier for the energy transferred from the fluid flow to this type of rotor blade.");
        add(MODID + ".configuration.turbine_blade_expansion", "Rotor Blade Expansion Coefficient");
        add(MODID + ".configuration.turbine_blade_expansion.tooltip", "Coefficient by which a set of this type of rotor blade multiplies the volume of the fluid in the oncoming flow.");
        ...
        add(MODID + ".configuration.turbine_coil_conductivity.tooltip", "Multiplier for the energy generated by this type of dynamo coil.");
        add(MODID + ".configuration.turbine_coil_rule", "Dynamo Coil Placement Rules");
        add(MODID + ".configuration.turbine_coil_rule.tooltip", "Placement rule to be parsed for this type of dynamo coil.");
        add(MODID + ".configuration.turbine_connector_rule", "Coil Connector Placement Rules");
        add(MODID + ".configuration.turbine_connector_rule.tooltip", "Placement rule to be parsed for this type of coil connector.");
        ...
        add(MODID + ".configuration.radiation_sound_volumes.tooltip", "Modifiers for the volumes of radiation sound effects.");
    ...
    @SafeVarargs
    private void simpleItems(Function<String, String> stringFunction, DeferredItem<Item>... items) {
        for (DeferredItem<Item> item : items) {
            add(item.asItem(), capitalize(stringFunction.apply(item.getId().getPath())));
        }
    }
    ...
    private void replaceItems(List<String> list, HashMap<String, DeferredItem<Item>> map, String prepend, String append, Map<String, String> replacers) {
        for (String name : list) {
            if (replacers.containsKey(name)) {
                ...
                add(map.get(name).asItem(), prepend + capitalize(name, true) + append);
            }
        }
    }
    ...
    private String capitalize(String input, boolean hypenate) {
        if (hypenate) {
            input = input.replaceFirst("_(?=\\d+$)", "-");
        }
