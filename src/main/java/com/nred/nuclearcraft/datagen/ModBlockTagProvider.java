...
class ModBlockTagProvider extends BlockTagsProvider {
    ...
    public void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(blockValues(TRITIUM_LAMP, SUPERCOLD_ICE, HEAVY_WATER_MODERATOR, SOLIDIFIED_CORIUM, UNIVERSAL_BIN, MACHINE_INTERFACE, NUCLEAR_FURNACE, DECAY_GENERATOR, GEIGER_COUNTER_BLOCK, RADIATION_SCRUBBER).toArray(Block[]::new));
