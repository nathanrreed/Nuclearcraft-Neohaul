...
class ModBlockTagProvider extends BlockTagsProvider {
    ...
    public void addTags(HolderLookup.Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(blockValues(ORE_MAP, INGOT_BLOCK_MAP, MATERIAL_BLOCK_MAP, RAW_BLOCK_MAP, FERTILE_ISOTOPE_MAP, COLLECTOR_MAP, SOLAR_MAP, TURBINE_MAP, HX_MAP, FISSION_REACTOR_MAP, BATTERY_MAP, RTG_MAP, MACHINE_MAP, QUANTUM_MAP, PROCESSOR_MAP).toArray(Block[]::new))
                .add(blockValues(TRITIUM_LAMP, SUPERCOLD_ICE, HEAVY_WATER_MODERATOR, SOLIDIFIED_CORIUM, UNIVERSAL_BIN, MACHINE_INTERFACE, DISTRIBUTOR_INLET, DISTRIBUTOR_OUTLET, DISTRIBUTOR_BUFFER, NUCLEAR_FURNACE, DECAY_GENERATOR, GEIGER_COUNTER_BLOCK, RADIATION_SCRUBBER).toArray(Block[]::new))
                .addOptional(CREATE_TURBINE_ROTOR_BEARING.getId());
