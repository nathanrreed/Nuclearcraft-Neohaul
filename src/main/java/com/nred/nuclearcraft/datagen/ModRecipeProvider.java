...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    public void buildRecipes(RecipeOutput recipeOutput) {
        ...
        new ElectrolyzerAnodeProvider(recipeOutput);
        new ElectrolyzerCathodeProvider(recipeOutput);
        new ElectrolyzerElectrolyteProvider(recipeOutput);
        new InfiltratorPressureFluidProvider(recipeOutput);
        new MachineDiaphragmProvider(recipeOutput);
        new MachineSieveAssemblyProvider(recipeOutput);
