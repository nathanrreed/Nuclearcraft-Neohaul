...
public class ModBlockLootTableSubProvider extends BlockLootSubProvider {
    ...
    public void generate() {
        ...
        dropSelf(DISTRIBUTOR_INLET.get());
        dropSelf(DISTRIBUTOR_OUTLET.get());
        dropSelf(DISTRIBUTOR_BUFFER.get());
    ...
    protected @NotNull Iterable<Block> getKnownBlocks() {
        ...
        all.addAll(blockValues(GLOWING_MUSHROOM, GLOWING_MUSHROOM_BLOCK, WASTELAND_PORTAL, GLOWING_MUSHROOM_STEM_BLOCK, TRITIUM_LAMP, WASTELAND_EARTH, HEAVY_WATER_MODERATOR, SUPERCOLD_ICE, SOLIDIFIED_CORIUM, UNIVERSAL_BIN, MACHINE_INTERFACE, DISTRIBUTOR_INLET, DISTRIBUTOR_OUTLET, DISTRIBUTOR_BUFFER, NUCLEAR_FURNACE, DECAY_GENERATOR));
        return all;
    }
}