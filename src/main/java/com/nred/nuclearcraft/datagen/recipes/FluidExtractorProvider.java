...
import static com.nred.nuclearcraft.registration.FluidRegistration.CHOCOLATE;
...
public class FluidExtractorProvider {
    public FluidExtractorProvider(RecipeOutput recipeOutput) {
        new ProcessorRecipeBuilder(FluidExtractorRecipe.class, 1, 1).addItemInput(FOOD_MAP.get("ground_cocoa_nibs"), 1).addItemResult(FOOD_MAP.get("cocoa_solids"), 1).addFluidResult(CHOCOLATE.get("cocoa_butter"), 144).save(recipeOutput);
