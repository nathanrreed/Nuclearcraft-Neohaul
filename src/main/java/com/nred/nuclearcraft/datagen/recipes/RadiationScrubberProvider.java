...
public class RadiationScrubberProvider {
    public RadiationScrubberProvider(RecipeOutput recipeOutput) {
        new BasicRecipeBuilder<>(new RadiationScrubberRecipe(SizedChanceItemIngredient.of(COMPOUND_MAP.get("borax"), 1), null, SizedChanceItemIngredient.of(COMPOUND_MAP.get("irradiated_borax"), 1), null, 12000, 200, 1.0)).save(recipeOutput, ncLoc("radiation_scrubberirradiated_borax"));
        new RadiationScrubberRecipeBuilder(new RadiationScrubberRecipe(null, NCFluid.sizedIngredient(CUSTOM_FLUID_MAP.get("radaway"), 250), null, NCFluid.sizedIngredient(FLAMMABLE_MAP.get("ethanol"), 250), 2400, 40, 5.0)).save(recipeOutput, ncLoc("radiation_scrubber_radaway"));
        new RadiationScrubberRecipeBuilder(new RadiationScrubberRecipe(null, NCFluid.sizedIngredient(CUSTOM_FLUID_MAP.get("radaway_slow"), 250), null, NCFluid.sizedIngredient(FLAMMABLE_MAP.get("redstone_ethanol"), 250), 96000, 20, 0.25)).save(recipeOutput, ncLoc("radiation_scrubberradaway_slow"));
    }
