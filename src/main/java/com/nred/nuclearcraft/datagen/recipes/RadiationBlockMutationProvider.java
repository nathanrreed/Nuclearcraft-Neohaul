...
public class RadiationBlockMutationProvider {
    public RadiationBlockMutationProvider(RecipeOutput recipeOutput) {
        ...
        new BasicRecipeBuilder<>(new RadiationBlockMutationRecipe(List.of(SizedChanceItemIngredient.of(ItemTags.SAPLINGS, 1)), Ingredient.of(Blocks.DEAD_BUSH), 4.0)).save(recipeOutput, ncLoc("sapling_mutation"));
    }
}