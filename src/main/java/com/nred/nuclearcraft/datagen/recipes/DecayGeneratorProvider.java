...
public class DecayGeneratorProvider {
    public DecayGeneratorProvider(RecipeOutput recipeOutput) {
        new RecipeBuilder(INGOT_BLOCK_MAP.get("thorium"), INGOT_BLOCK_MAP.get("lead"), 12000D / 0.75D, 0.75D, RadSources.THORIUM).save(recipeOutput, ncLoc("lead_from_thorium"));
        ...
        new RecipeBuilder(FERTILE_ISOTOPE_MAP.get("uranium"), INGOT_BLOCK_MAP.get("lead"), 1200D, 1D, RadSources.URANIUM_238).save(recipeOutput, ncLoc("lead_from_uranium"));
        new RecipeBuilder(FERTILE_ISOTOPE_MAP.get("neptunium"), INGOT_BLOCK_MAP.get("lead"), 12000D / 2.2D, 2.2D, RadSources.NEPTUNIUM_237).save(recipeOutput, ncLoc("lead_from_neptunium"));
        new RecipeBuilder(FERTILE_ISOTOPE_MAP.get("plutonium"), FERTILE_ISOTOPE_MAP.get("uranium"), 12000D / 3D, 3D, RadSources.PLUTONIUM_242).save(recipeOutput, ncLoc("uranium_from_plutonium"));
        new RecipeBuilder(FERTILE_ISOTOPE_MAP.get("americium"), INGOT_BLOCK_MAP.get("lead"), 12000D / 18D, 18D, RadSources.AMERICIUM_243).save(recipeOutput, ncLoc("lead_from_americium"));
        ...
        new RecipeBuilder(FERTILE_ISOTOPE_MAP.get("californium"), INGOT_BLOCK_MAP.get("lead"), 12000D / 1000D, 1000D, RadSources.CALIFORNIUM_252).save(recipeOutput, ncLoc("lead_from_californium"));
    }
