...
public class FluidMixerProvider {
    public FluidMixerProvider(RecipeOutput recipeOutput) {
        ...
        new ProcessorRecipeBuilder(FluidMixerRecipe.class, 10 / 9.0, 1).addFluidInput(MOLTEN_MAP.get("lithium_7"), INGOT_VOLUME / 2).addFluidInput(MOLTEN_MAP.get("lithium_6"), NUGGET_VOLUME).addFluidResult(MOLTEN_MAP.get("lithium"), NUGGET_VOLUME * 10).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(FluidMixerRecipe.class, 0.5, 1).addFluidInput(CHOCOLATE_MAP.get("chocolate_liquor"), INGOT_VOLUME / 2).addFluidInput(CHOCOLATE_MAP.get("cocoa_butter"), INGOT_VOLUME / 2).addFluidResult(CHOCOLATE_MAP.get("unsweetened_chocolate"), INGOT_VOLUME).save(recipeOutput);
