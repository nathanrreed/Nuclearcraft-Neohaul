...
public class AlloyFurnaceRecipeProvider {
    public AlloyFurnaceRecipeProvider(RecipeOutput recipeOutput) {
        ...
        new ProcessorRecipeBuilder(AlloyFurnaceRecipe.class, 1, 1).addItemInput(List.of(ingotDust("iron", 1), new SizedChanceItemIngredient(Ingredient.fromValues(Stream.of(new Ingredient.TagValue(tag(Tags.Items.DUSTS, "coal")), new Ingredient.TagValue(tag(Tags.Items.DUSTS, "graphite")), new Ingredient.TagValue(tag(Tags.Items.INGOTS, "graphite")), new Ingredient.ItemValue(new ItemStack(Items.COAL)))), 2))).addItemResult(ALLOY_MAP.get("steel"), 1).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(AlloyFurnaceRecipe.class, 1.5, 1.5).addItemInput(List.of(SizedChanceItemIngredient.of(ALLOY_MAP.get("ferroboron"), 1), ingotDust("lithium", 1))).addItemResult(ALLOY_MAP.get("tough"), 2).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(AlloyFurnaceRecipe.class, 2, 2).addItemInput(List.of(SizedChanceItemIngredient.of(ALLOY_MAP.get("tough"), 1), SizedChanceItemIngredient.of(ALLOY_MAP.get("hard_carbon"), 1))).addItemResult(ALLOY_MAP.get("extreme"), 1).save(recipeOutput);
        new ProcessorRecipeBuilder(AlloyFurnaceRecipe.class, 1.5, 1.5).addItemInput(List.of(SizedChanceItemIngredient.of(ALLOY_MAP.get("extreme"), 1), SizedChanceItemIngredient.of(GEM_MAP.get("boron_arsenide"), 1))).addItemResult(ALLOY_MAP.get("thermoconducting"), 2).save(recipeOutput);
