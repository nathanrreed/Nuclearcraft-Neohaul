...
//        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 0.5D, 1D).addFluidInput(MOLTEN_MAP.get("nickel_oxide"), INGOT_VOLUME / 2).addFluidInput(MOLTEN_MAP.get("carbon"), COAL_DUST_VOLUME / 2).addFluidResult(MOLTEN_MAP.get("nickel"), INGOT_VOLUME / 2).addFluidResult(GAS_MAP.get("carbon_monoxide"), BUCKET_VOLUME / 2).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(FLAMMABLE_MAP.get("methanol"), BUCKET_VOLUME / 4).addFluidInput(GAS_MAP.get("hydrogen"), BUCKET_VOLUME / 4).addFluidResult(GAS_MAP.get("methane"), BUCKET_VOLUME / 4).addFluidResult(Fluids.WATER, BUCKET_VOLUME / 4).save(recipeOutput);
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 0.5, 1).addFluidInput(FLAMMABLE_MAP.get("methanol"), BUCKET_VOLUME / 4).addFluidInput(ACID_MAP.get("hydrofluoric_acid"), BUCKET_VOLUME / 4).addFluidResult(GAS_MAP.get("fluoromethane"), BUCKET_VOLUME / 4).addFluidResult(Fluids.WATER, BUCKET_VOLUME / 4).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 2, 1).addFluidInput(FLAMMABLE_MAP.get("difluorobenzene"), BUCKET_VOLUME / 4).addFluidInput(MOLTEN_MAP.get("sodium_sulfide"), INGOT_VOLUME / 4).addFluidResult(MOLTEN_MAP.get("polyphenylene_sulfide"), INGOT_VOLUME / 4).addFluidResult(SALT_SOLUTION_MAP.get("sodium_fluoride_solution"), GEM_VOLUME / 2).save(recipeOutput);
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 2, 1).addFluidInput(FLAMMABLE_MAP.get("difluorobenzene"), BUCKET_VOLUME / 4).addFluidInput(MOLTEN_MAP.get("potassium_sulfide"), INGOT_VOLUME / 4).addFluidResult(MOLTEN_MAP.get("polyphenylene_sulfide"), INGOT_VOLUME / 4).addFluidResult(SALT_SOLUTION_MAP.get("potassium_fluoride_solution"), GEM_VOLUME / 2).save(recipeOutput);

        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 0.5, 1).addFluidInput(GAS_MAP.get("fluoromethane"), BUCKET_VOLUME / 2).addFluidInput(MOLTEN_MAP.get("silicon"), INGOT_VOLUME / 4).addFluidResult(FLAMMABLE_MAP.get("dimethyldifluorosilane"), BUCKET_VOLUME / 4).save(recipeOutput);
