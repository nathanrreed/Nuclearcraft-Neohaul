...
public class ChemicalReactorProvider {
    public ChemicalReactorProvider(RecipeOutput recipeOutput) {
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(MOLTEN_MAP.get("boron"), 144).addFluidInput(HYDROGEN_TAG, 1500).addFluidResult(GAS_MAP.get("diborane"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(NITROGEN_TAG, 250).addFluidInput(HYDROGEN_TAG, 750).addFluidResult(GAS_MAP.get("ammonia"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(HYDROGEN_TAG, 500).addFluidInput(OXYGEN_TAG, 250).addFluidResult(Fluids.WATER, 500).save(recipeOutput);
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(GAS_MAP.get("deuterium"), 500).addFluidInput(OXYGEN_TAG, 250).addFluidResult(CUSTOM_FLUID_MAP.get("heavy_water"), 500).save(recipeOutput);
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(HYDROGEN_TAG, 250).addFluidInput(GAS_MAP.get("fluorine"), 250).addFluidResult(ACID_MAP.get("hydrofluoric_acid"), 250).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(MOLTEN_MAP.get("sulfur"), 333).addFluidInput(OXYGEN_TAG, 500).addFluidResult(GAS_MAP.get("sulfur_dioxide"), 500).save(recipeOutput);
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(GAS_MAP.get("sulfur_dioxide"), 500).addFluidInput(OXYGEN_TAG, 250).addFluidResult(GAS_MAP.get("sulfur_trioxide"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(MOLTEN_MAP.get("sulfur"), 333).addFluidInput(HYDROGEN_TAG, 500).addFluidResult(GAS_MAP.get("hydrogen_sulfide"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(OXYGEN_TAG, 250).addFluidInput(GAS_MAP.get("fluorine"), 500).addFluidResult(GAS_MAP.get("oxygen_difluoride"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(GAS_MAP.get("carbon_dioxide"), 250).addFluidInput(HYDROGEN_TAG, 250).addFluidResult(GAS_MAP.get("carbon_monoxide"), 250).addFluidResult(Fluids.WATER, 250).save(recipeOutput);
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(GAS_MAP.get("carbon_monoxide"), 250).addFluidInput(HYDROGEN_TAG, 500).addFluidResult(FLAMMABLE_MAP.get("methanol"), 250).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 3, 4).addFluidInput(GAS_MAP.get("ethylene"), 500).addFluidInput(OXYGEN_TAG, 500).addFluidResult(GAS_MAP.get("acetylene"), 500).addFluidResult(Fluids.WATER, 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 2, 2).addFluidInput(FLAMMABLE_MAP.get("benzene"), 500).addFluidInput(OXYGEN_TAG, 250).addFluidResult(FLAMMABLE_MAP.get("phenol"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 2, 1).addFluidInput(MOLTEN_MAP.get("alugentum"), 72).addFluidInput(OXYGEN_TAG, 3000).addFluidResult(MOLTEN_MAP.get("alumina"), 144).addFluidResult(MOLTEN_MAP.get("silver"), 72).save(recipeOutput);
