...
public class RockCrusherProvider {
    public RockCrusherProvider(RecipeOutput recipeOutput) {
        ...
        new ProcessorRecipeBuilder(RockCrusherRecipe.class, 1, 1).addItemInput(Ingredient.of(Items.ANDESITE, Items.POLISHED_ANDESITE), 1).addItemResult(DUST_MAP.get("beryllium"), 50, 2).addItemResult(COMPOUND_MAP.get("alugentum"), 30, 2).addItemResult(GEM_DUST_MAP.get("arsenic"), 30, 1).save(recipeOutput);
    }
}