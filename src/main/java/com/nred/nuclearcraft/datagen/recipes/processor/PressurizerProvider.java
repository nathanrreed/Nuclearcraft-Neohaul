...
public class PressurizerProvider {
    public PressurizerProvider(RecipeOutput recipeOutput) {
        new ProcessorRecipeBuilder(PressurizerRecipe.class, 1, 1).addItemInput(tag(Tags.Items.DUSTS, "graphite"), 1).addItemResult(Items.COAL, 1).save(recipeOutput);
        new ProcessorRecipeBuilder(PressurizerRecipe.class, 1, 1).addItemInput(tag(Tags.Items.INGOTS, "graphite"), 1).addItemResult(PART_MAP.get("pyrolytic_carbon"), 1).save(recipeOutput);
        new ProcessorRecipeBuilder(PressurizerRecipe.class, 1, 1).addItemInput(tag(Tags.Items.DUSTS, "diamond"), 1).addItemResult(Items.DIAMOND, 1).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(PressurizerRecipe.class, 1, 1).addItemInput(tag(Tags.Items.DUSTS, "quartz"), 1).addItemResult(Items.QUARTZ, 1).save(recipeOutput);
        new ProcessorRecipeBuilder(PressurizerRecipe.class, 1.5, 1.5).addItemInput(tag(Tags.Items.DUSTS, "obsidian"), 4).addItemResult(Items.OBSIDIAN, 1).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(PressurizerRecipe.class, 2, 2).addItemInput(tag(Tags.Items.DUSTS, "steel"), 1).addItemResult(PART_MAP.get("sintered_steel"), 1).save(recipeOutput);
