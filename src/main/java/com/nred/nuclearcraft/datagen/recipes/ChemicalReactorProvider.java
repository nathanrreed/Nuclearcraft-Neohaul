...
public class ChemicalReactorProvider {
    public ChemicalReactorProvider(RecipeOutput recipeOutput) {
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 1, 1).addFluidInput(GAS_MAP.get("deuterium"), 500).addFluidInput(GAS_MAP.get("oxygen"), 250).addFluidResult(CUSTOM_FLUID.get("heavy_water"), 500).save(recipeOutput);
        ...
        new ProcessorRecipeBuilder(ChemicalReactorRecipe.class, 2, 2).addFluidInput(FLAMMABLE_MAP.get("phenol"), 500).addFluidInput(CUSTOM_FLUID.get("hydrogen_peroxide"), 500).addFluidResult(SALT_SOLUTION_MAP.get("hydroquinone_solution"), 333).save(recipeOutput);
