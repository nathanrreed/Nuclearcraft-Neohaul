...
//
//public class TurbineMultiblock extends AbstractCuboidMultiblockController<TurbineMultiblock> implements ITurbineMachine, IDebuggable { //ITurbineWriter
//
...
//    public TurbineMultiblock(final Level world) {
//
//        super(world);
...
//
//    @Override
//    public boolean isPartCompatible(final IMultiblockPart<TurbineMultiblock> part) {
...
//     */
//    @Override
//    protected void onPartAdded(IMultiblockPart<TurbineMultiblock> newPart) {
////
...
//     */
//    @Override
//    protected void onPartRemoved(IMultiblockPart<TurbineMultiblock> oldPart) {
////
...
////                this.getPartsCount() * TurbineMultiblock.getAdjustedPowerProductionMultiplier()));
...
//     */
//    @Override
//    protected void onAssimilate(IMultiblockController<TurbineMultiblock> assimilated) {
////
////        if (!(assimilated instanceof TurbineMultiblock)) {
////
////            Log.LOGGER.warn(Log.TURBINE, "[{}] Turbine @ {} is attempting to assimilate a non-Turbine machine! That machine's data will be lost!", CodeHelper.getWorldSideName(this.getWorld()), this.getReferenceCoord());
////            return;
////        }
////
////        this._data.onAssimilate((((TurbineMultiblock) assimilated)._data));
//    }
//
//    /**
...
//     */
//    @Override
//    protected void onAssimilated(IMultiblockController<TurbineMultiblock> assimilator) {
//
...
////
////        return this.mapBoundingBoxCoordinates((min, max) -> validateRotor(bearing, validatorCallback, bearing.getRotorDirection(), min, max), false);
////    }
////
////    /**
////     * isMachineWhole-helper
...
//        final BlockPos position = new BlockPos(x, y, z);
//
//        validatorCallback.setLastError(position, "multiblock.validation.turbine.invalid_block_for_exterior", ModBlock.getNameForTranslation(world.getBlockState(position).getBlock()));
//        return false;
//    }
//
////    /**
