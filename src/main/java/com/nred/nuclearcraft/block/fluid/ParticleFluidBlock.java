...
public class ParticleFluidBlock extends NCFluidBlock {
    public ParticleFluidBlock(FlowingFluid fluid, Properties properties) {
    ...
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        if (entity instanceof LivingEntity livingEntity) {
            livingEntity.addEffect(SimpleHelper.newEffect(MobEffects.CONFUSION, 2, 200));
