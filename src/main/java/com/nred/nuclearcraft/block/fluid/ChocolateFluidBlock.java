...
public class ChocolateFluidBlock extends NCFluidBlock {
    public ChocolateFluidBlock(FlowingFluid fluid, Properties properties) {
    ...
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        if (entity instanceof LivingEntity livingEntity) {
            ...
            livingEntity.addEffect(SimpleHelper.newEffect(MobEffects.REGENERATION, 1, 100));
        }
    }
