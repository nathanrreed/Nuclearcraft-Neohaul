...
public class CoolantFluidBlock extends NCFluidBlock {
    public CoolantFluidBlock(FlowingFluid fluid, Properties properties) {
    ...
    protected void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            ...
            livingEntity.addEffect(SimpleHelper.newEffect(MobEffects.FIRE_RESISTANCE, 1, 100));
        }
    }
