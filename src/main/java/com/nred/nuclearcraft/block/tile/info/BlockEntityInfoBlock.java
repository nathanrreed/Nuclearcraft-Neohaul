...
public abstract class BlockEntityInfoBlock<TILE extends BlockEntity> {
    public final String name;

    protected final Class<TILE> tileClass;
    protected final BiFunction<BlockPos, BlockState, TILE> tileSupplier;

    public BlockEntityInfoBlock(String name, Class<TILE> tileClass, BiFunction<BlockPos, BlockState, TILE> tileSupplier) {
        this.name = name;
