...
//    public static abstract class CobblestoneGeneratorAbstract extends TilePassiveAbstract { TODO
//        public CobblestoneGeneratorAbstract(String type, int rateMult) {
//            super("cobblestone_generator" + type, Ingredient.of(Blocks.COBBLESTONE), processor_passive_rate[0] * rateMult, -cobble_gen_power * rateMult);
//        }
//    }
//
...
//            super("water_source" + type, FluidIngredient.of(Fluids.WATER), processor_passive_rate[1] * rateMult);
//        }
//    }
//
...
//            super("nitrogen_collector" + type, FluidIngredient.of(GAS_MAP.get("nitrogen").still.get()), processor_passive_rate[2] * rateMult);
//        }
//    }
//
