...
public class PebbleFissionCoolerBlock extends GenericTooltipDeviceBlock<FissionReactor, IFissionPartType> {
    public PebbleFissionCoolerBlock(MultiblockPartProperties<IFissionPartType> properties) {
        super(properties);
    }
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        ...
        if (!level.isClientSide() && level.getBlockEntity(pos) instanceof PebbleFissionCoolerEntity cooler) {
