...
public class FissionChamberPortScreen extends InfoTileScreen<FissionChamberPortMenu, FissionChamberPortEntity, ItemPortUpdatePacket, BlockEntityMenuInfo<FissionChamberPortEntity>> {
    protected static final ResourceLocation gui_texture = ncLoc("screen/" + "fission_chamber_port");

    public FissionChamberPortScreen(FissionChamberPortMenu menu, Inventory playerInventory, Component title) {
