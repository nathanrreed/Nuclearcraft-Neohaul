...
public class SaltFissionHeaterScreen extends BasicFilteredFluidProcessorScreen<SaltFissionHeaterMenu, SaltFissionHeaterEntity, SaltFissionHeaterUpdatePacket, FissionCoolantHeaterRecipe> {
    ...
    public List<Component> heatInfo() {
        ...
        return Lists.newArrayList(Component.translatable(MODID + ".tooltip.fission_component.heat_stored", Component.literal(heat)).withStyle(ChatFormatting.YELLOW));
    }
