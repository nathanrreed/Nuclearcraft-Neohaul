...
public class FissionCoolerPortScreen extends InfoTileScreen<FissionCoolerPortMenu, FissionCoolerPortEntity, FluidPortUpdatePacket, BlockEntityMenuInfo<FissionCoolerPortEntity>> {
    protected static final ResourceLocation gui_texture = ncLoc("screen/" + "fission_cooler_port");

    public FissionCoolerPortScreen(FissionCoolerPortMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        renderGuiTank(guiGraphics, tile.getTanks().get(0), getGuiLeft() + 40, getGuiTop() + 31, 24, 24, 1);
        renderGuiTank(guiGraphics, tile.getTanks().get(1), getGuiLeft() + 112, getGuiTop() + 31, 24, 24, 1);
