...
public class PressurizerMenu extends ProcessorMenu {
    public static final int INPUT = 2;
    public static final int OUTPUT = 3;

    public PressurizerMenu(int containerId, Inventory inventory, ContainerLevelAccess access, ProcessorInfo info, DataSlot progress) {
