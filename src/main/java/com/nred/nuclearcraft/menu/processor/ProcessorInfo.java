...
public record ProcessorInfo(BlockPos pos, boolean redstoneMode, ArrayList<Integer> itemOutputSettings, ArrayList<Integer> fluidOutputSettings, Map<Direction, List<SideConfigEnums.SideConfigSetting>> itemSideConfig, Map<Direction, List<SideConfigEnums.SideConfigSetting>> fluidSideConfig, String typeName) {
