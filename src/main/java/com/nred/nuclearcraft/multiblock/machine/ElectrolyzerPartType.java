...
public enum ElectrolyzerPartType implements IHeatExchangerPartType {
    ...
    ElectrolyzerPartType(final Supplier<@NotNull Supplier<@NotNull BlockEntityType<?>>> tileTypeSupplier,
