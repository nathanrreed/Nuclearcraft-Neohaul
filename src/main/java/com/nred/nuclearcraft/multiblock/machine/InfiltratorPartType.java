...
public enum InfiltratorPartType implements IHeatExchangerPartType {
    ...
    InfiltratorPartType(final Supplier<@NotNull Supplier<@NotNull BlockEntityType<?>>> tileTypeSupplier,
