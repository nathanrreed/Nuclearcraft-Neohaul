...
public enum DistillerPartType implements IHeatExchangerPartType {
    ...
    DistillerPartType(final Supplier<@NotNull Supplier<@NotNull BlockEntityType<?>>> tileTypeSupplier,
