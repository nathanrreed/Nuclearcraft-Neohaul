...
//		TurbinePlacement.recipe_handler.refreshCache();
    ...
    public static abstract class BasicCompoundRule<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends PlacementRule<MULTIBLOCK, T> {
    ...
    public static <MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> List<String> concatDependencies(List<PlacementRule<MULTIBLOCK, T>> rules) {
    ...
    public static <MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> boolean mergeRequiresRecheck(List<PlacementRule<MULTIBLOCK, T>> rules) {
    ...
    public static abstract class Adjacent<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends PlacementRule<MULTIBLOCK, T> {
    ...
    public static class PlacementMap<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends Object2ObjectOpenHashMap<String, PlacementRule<MULTIBLOCK, T>> {
