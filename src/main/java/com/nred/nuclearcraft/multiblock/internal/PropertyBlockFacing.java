...
public enum PropertyBlockFacing implements StringRepresentable {
    ...
    public static final EnumProperty<PropertyBlockFacing> FACINGS = EnumProperty.create("facings", PropertyBlockFacing.class);
