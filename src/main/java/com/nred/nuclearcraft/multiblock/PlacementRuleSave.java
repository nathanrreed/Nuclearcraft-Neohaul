...
//
//public abstract class PlacementRuleSave<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> {
//
//    public final @Nullable List<PlacementRuleSave<MULTIBLOCK, T>> subRules;
//    public final List<String> dependencies;
//    public final boolean requiresRecheck;
//
//    public PlacementRuleSave(@Nullable List<PlacementRuleSave<MULTIBLOCK, T>> subRules, List<String> dependencies, boolean requiresRecheck) {
//        this.subRules = subRules;
//        this.dependencies = dependencies;
//        this.requiresRecheck = requiresRecheck;
//    }
//
//    public @Nullable List<PlacementRuleSave<MULTIBLOCK, T>> getSubRules() {
//        return subRules;
//    }
//
...
//    // Rule Parser
//
//    public static <MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> PlacementRuleSave<MULTIBLOCK, T> parse(String string, List<RuleParser<MULTIBLOCK, T>> parsers) {
//        for (RuleParser<MULTIBLOCK, T> parser : parsers) {
//            PlacementRuleSave<MULTIBLOCK, T> rule = parser.parseRule(string);
//            if (rule != null) {
//                return rule;
//            }
//        }
...
//    }
//
//    public static abstract class RuleParser<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> {
//
//        /**
//         * Returns non-null PlacementRule if the string is successfully parsed.
//         */
//        protected abstract @Nullable PlacementRuleSave<MULTIBLOCK, T> parseRule(String s);
//    }
//
//    public static abstract class DefaultRuleParser<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends RuleParser<MULTIBLOCK, T> {
//
//        @Override
//        protected @Nullable PlacementRuleSave<MULTIBLOCK, T> parseRule(String string) {
//            string = string.toLowerCase(Locale.ROOT);
//
//            List<PlacementRuleSave<MULTIBLOCK, T>> rules = new ArrayList<>();
//            String pattern = string.contains("&&") ? "&&" : "||";
//            for (String s : string.split(Pattern.quote(pattern))) {
//                PlacementRuleSave<MULTIBLOCK, T> rule = partialParse(s);
//                if (rule == null) {
//                    return null;
//                }
//                rules.add(rule);
...
//        }
//
//        protected abstract @Nullable PlacementRuleSave<MULTIBLOCK, T> partialParse(String s);
//    }
//
//    // Basic Compound Rule Types
//
//    public static abstract class BasicCompoundRule<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends PlacementRuleSave<MULTIBLOCK, T> {
//
//        public BasicCompoundRule(List<PlacementRuleSave<MULTIBLOCK, T>> rules) {
...
//            if (subRules != null) {
//                for (PlacementRuleSave<MULTIBLOCK, T> subRule : subRules) {
...
//    }
//
//    public static class And<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends BasicCompoundRule<MULTIBLOCK, T> {
//
//        public And(List<PlacementRuleSave<MULTIBLOCK, T>> rules) {
//            super(rules);
//        }
//
//        @Override
...
//            for (PlacementRuleSave<MULTIBLOCK, T> rule : subRules) {
...
//    }
//
//    public static class Or<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends BasicCompoundRule<MULTIBLOCK, T> {
//
//        public Or(List<PlacementRuleSave<MULTIBLOCK, T>> rules) {
//            super(rules);
//        }
//
//        @Override
...
//    }
//
//    public static <MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> List<String> concatDependencies(List<PlacementRuleSave<MULTIBLOCK, T>> rules) {
//        ObjectSet<String> dependencies = new ObjectOpenHashSet<>();
//        for (PlacementRuleSave<MULTIBLOCK, T> rule : rules) {
...
//    }
//
//    public static <MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> boolean mergeRequiresRecheck(List<PlacementRuleSave<MULTIBLOCK, T>> rules) {
...
//    // Basic Sub-Rule
//
//    public static abstract class Adjacent<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends PlacementRuleSave<MULTIBLOCK, T> {
//
...
//                } else {
//                    loop:
//                    for (Direction[] axialDirs : PosHelper.axialDirsList()) {
//                        for (Direction dir : axialDirs) {
//                            if (!satisfied(tile, dir, simulate)) {
//                                continue loop;
//                            }
//                        }
...
//
//                    loop:
//                    for (Direction[] typeDirs : (adjType == AdjacencyType.VERTEX ? PosHelper.VERTEX_DIRS : PosHelper.EDGE_DIRS)) {
//                        for (Direction dir : typeDirs) {
//                            if (!dirs[dir.ordinal()]) {
//                                continue loop;
//                            }
//                        }
...
//        }
//
//        public abstract boolean satisfied(T tile, Direction dir, boolean simulate);
//    }
//
...
//    // Placement Map
//
//    public static class PlacementMap<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends Object2ObjectOpenHashMap<String, PlacementRuleSave<MULTIBLOCK, T>> {
//
//        @Override
//        public PlacementRuleSave<MULTIBLOCK, T> put(final String ruleID, final PlacementRuleSave<MULTIBLOCK, T> rule) {
//            rule.checkIsRuleAllowed(ruleID);
//            PlacementRuleSave<MULTIBLOCK, T> ret = super.put(ruleID, rule);
//            checkCycles(ruleID, rule);
//            return ret;
//        }
//
//        public void checkCycles(final String ruleID, final PlacementRuleSave<MULTIBLOCK, T> rule) {
...
//    // Tooltip Builder
//
//    public static abstract class TooltipBuilder<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> {
//
//        /**
//         * Returns non-null PlacementRule if the tooltip is successfully built.
//         */
//        public abstract String buildTooltip(PlacementRuleSave<MULTIBLOCK, T> rule);
//    }
//
//    public static class DefaultTooltipBuilder<MULTIBLOCK extends AbstractMultiblockController<MULTIBLOCK>, T extends AbstractMultiblockPart<MULTIBLOCK>> extends TooltipBuilder<MULTIBLOCK, T> {
//
//        @Override
//        public String buildTooltip(PlacementRuleSave<MULTIBLOCK, T> rule) {
...
//                for (PlacementRuleSave<MULTIBLOCK, T> r : rule.getSubRules()) {
