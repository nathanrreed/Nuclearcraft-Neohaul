...
public class ArmorHelper {
	public static boolean isArmor(Item item, boolean includeHorse) {
		return item instanceof ArmorItem || item instanceof ElytraItem || (includeHorse && isHorseArmor(item));
	}
	...
	private static boolean isModHorseArmor(Item item) {
		return item instanceof AnimalArmorItem; // TODO ModCheck.cofhCoreLoaded() &&
	}
}