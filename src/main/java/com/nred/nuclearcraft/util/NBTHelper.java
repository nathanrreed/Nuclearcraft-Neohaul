...
//		if (nbt == null) {
//			stack.setTagCompound(nbt = new CompoundTag());
//		}
...
//	@SafeVarargs
//	public static CompoundTag writeAllItems(CompoundTag tag, List<ItemStack>... lists) {
//		return writeAllItems(tag, "Items", lists);
//	}
//
//	@SafeVarargs
//	public static CompoundTag writeAllItems(CompoundTag tag, String name, List<ItemStack>... lists) {
//		if (lists.length == 0) {
//			return tag;
//		}
...
//	@SafeVarargs
//	public static void readAllItems(CompoundTag tag, List<ItemStack>... lists) {
//		readAllItems(tag, "Items", lists);
//	}
//
//	@SafeVarargs
//	public static void readAllItems(CompoundTag tag, String name, List<ItemStack>... lists) {
//		if (lists.length == 0) {
//			return;
//		}
